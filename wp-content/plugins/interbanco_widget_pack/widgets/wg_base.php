 ...
 * Time: 4:49 PM
 */
class wg_base extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        $widget_options = array(
            'classname' => 'wg_base',
            'description' => 'Widget para mostrar [description] de Interbanco'
        );
        ...
        parent::__construct('wg_base', 'Widget para mostrar [description] de Interbanco', $widget_options, $control_options);
...
//        }
        ...
        $service_result = object; //invoke_service($instance['url']);
        $service_result = 0;
        ...
        <div class="interbanco_widget_box interbanco_wg_base">
            ...
            <div class="interbanco_widget_body">
                <span>valor <?php echo number_format_i18n((double)$service_result, 2) ?></span>
            </div>
...
//add_action('widgets_init', 'interbanco_load_wg_base');
/**
 * Widget Registration.
 *
 ...
 *
 */
function interbanco_load_wg_base()
{
    register_widget('wg_base');
}